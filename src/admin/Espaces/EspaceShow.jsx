  ...
  return (
    <div className="max-w-lg mx-auto bg-[#EFF7F6] p-10 rounded-2xl shadow-sm border border-[#B2F7EF]">
      ...
      {espace.photo_salle ? (
        ...
        <div className="w-full h-56 bg-[#B2F7EF] rounded-2xl mb-6 flex items-center justify-center text-gray-400 text-sm">
          Aucune photo
        </div>
      )}

      <h2 className="text-xl font-bold text-[#3a3a3a] mb-6">{espace.nom}</h2>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between border-b border-[#B2F7EF] pb-3">
          ...
          <span className="text-sm font-medium text-[#3a3a3a]">{espace.prix_reservation} FCFA</span>
        </div>
        <div className="flex justify-between border-b border-[#B2F7EF] pb-3">
          <span className="text-sm text-gray-400">Frais réservation</span>
          <span className="text-sm font-medium text-[#3a3a3a]">{espace.frais_reservation} FCFA</span>
        </div>
        <div className="flex justify-between border-b border-[#B2F7EF] pb-3">
