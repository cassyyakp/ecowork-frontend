...
function ReservationShow() {
  ...
  if (!reservation) return <p className="text-sm text-gray-400">Réservation introuvable.</p>;
    ...
    <div className="max-w-lg mx-auto bg-[#EFF7F6] p-10 rounded-2xl shadow-sm border border-[#B2F7EF]">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between border-b border-[#B2F7EF] pb-3">
          ...
          <span className="text-sm font-medium text-[#3a3a3a]">{reservation.utilisateur}</span>
        </div>
        <div className="flex justify-between border-b border-[#B2F7EF] pb-3">
        ...
        <div className="flex justify-between border-b border-[#B2F7EF] pb-3">
          ...
          <span className="text-sm font-medium text-[#3a3a3a]">{reservation.prix_total} FCFA</span>
        </div>
        <div className="flex justify-between border-b border-[#B2F7EF] pb-3">
