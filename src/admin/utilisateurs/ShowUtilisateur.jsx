...
function ShowUtilisateur() {
    ...
    if (!utilisateur) return <p className="text-center mt-10 text-gray-400">Utilisateur introuvable</p>;

    return (
        <>
            <h1 className="text-font text-center mt-2 text-3xl">DÉTAIL UTILISATEUR</h1>

            <div className="max-w-lg mx-auto mt-10 bg-[#EFF7F6] border border-default rounded-base p-6 space-y-4">
                ...
                <div className="flex justify-between border-b border-default pb-3">
                    ...
                    <span style={{
                        backgroundColor: utilisateur.id_type_compte === 1 ? '#7BDFF2' : '#F7D6E0',
                        color: '#3a3a3a'
